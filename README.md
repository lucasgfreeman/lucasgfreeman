...
Welcome to my portfolio! From maps and planispheres to almanacs, dictionaries, and charts, I’ve been studying data for as long as I can remember. My earliest memory involves anagramming a 🛑 sign on the way to kindergarten. The fact that my brain instinctively explored permutations shows the early curiosity I had for seeing patterns, rearranging symbols, and finding structure. Now, after twenty years in the veterinary world (with side quests in literature, psychology, and fitness), I am channeling the wealth of the data exploration I've encountered into a more data-driven approach to analysis and decision making.

My main areas of interest are:
- 🐶 Veterinary and animal science
- 🏺 Ancient and medieval history
- 🧠 Psychology, neurology, philosophy, and religion
...
- 🫱🏼‍🫲🏼 **Hiring a data analyst?** I’d be happy to discuss how my experience, interests, and skills could contribute to your organization. My [LinkedIn](http://www.linkedin.com/in/lucasgfreeman) 📫 and [resume](https://github.com/lucasgfreeman/lucasgfreeman/blob/main/LGFreeman_Data_Resume_2026.pdf) 📄 are linked here.
---
## 🦉 Bonus facts
...
- 📖 On my nightstand: *The Eye of the World* by Robert Jordan.

- 🎶 On my playlist: *Too Sweet* by Hozier, *White Horse* by Chris Stapleton, *Crystallize* by Lindsay Stirling.
  
- 🐈 My wife and I live outside of Nashville with our two cats, Emmy Jade and Olive Grace.
...
On my watchlist: Game of Thrones, season 5
-->
